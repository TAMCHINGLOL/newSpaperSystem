<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
	...
	<body class="body-color">
		...
		<div class="centent mar-t20">
			...
			<div class="tab-content" style="height: 1000px;">
				  <div class="tab-pane fade active in  main" id="tabContent1">
			            ...
			            <section class="basic">
			                <h3>基本信息</h3>
			                <form id="basicForm" action="/api/setUserInfo">
			                    <ul>
			                        <li>
			                            <label for="setPhoto">头像</label>
			                            <div class="inputbox">
			                                <div class="portrait-box">
												<?php if($info["head_img"] != ''): ?><img class="headpic" src="<?php echo ($info["head_img"]); ?>">
													<?php else: ?>
													<img class="headpic" src="/term/newSpaperSystem/Application/Home/View/public/img/default.gif"><?php endif; ?>
			                        ...
			                        <li>
			                            ...
			                            <div class="inputbox">
			                                <input type="text" id="uname" maxlength="30" value="<?php echo ($info["alias"]); ?>">
										</div>
			                        </li>
			                        <li>
			                            <label for="truename">真实姓名</label>
			                            <div class="inputbox">
			                                <input type="text" id="truename" name="truename" value="<?php echo ($info["username"]); ?>" maxlength="30">
			                            </div>
			                        </li>
			                        <li>
			                            ...
			                            <div class="inputbox">
			                                <span class="select-box-sex"><select id="usex" name="gender">
												<option value="<?php echo ($info["sex"]); ?>" selected><?php echo ($info["sex"]); ?></option>
			                                    <option value="保密">保密</option> gender
			                        ...
			                        <li>
			                            ...
			                            <div class="inputbox">
			                                <input class="laydate-icon form_date" type="text" name="birthday" value="<?php echo ($info["birthday"]); ?>">
			                            </div>
			                        </li>
			                        <li>
			                            <label>现居住地</label>
			                            <div class="inputbox">
			                                ...
			                                <!--<span class="">-->
											<!--<div class="inputbox">-->
												<input type="text" id="city_id" name="cityname" placeholder="请输入详细地址" maxlength="60" value="<?php echo ($info["address"]); ?>" style="width: 280px">
											<!--</div>-->
			                        ...
			                        <li>
			                            ...
			                            <div class="inputbox">
			                                <textarea id="basArea" placeholder="一句话介绍一下自己吧，让别人更了解你" maxlength="200" name="description"><?php echo ($info["backup"]); ?></textarea>
			                                <p class="extra-tips">还可以输入 <span id="tipsNum">200</span> 字</p>
			                            </div>
			                        </li>
			                    </ul>
								 <input type="hidden" name="stoken" id="stoken" value="18efe2116253c9b92077362399341113">                    <button type="submit" class="green-btn">保存</button>
			                </form>
			            </section>
				  </div>
				  <div class="tab-pane fade main" id="tabContent2">
		            ...
		            <div class="security">
		                <ul>
		                    <li>
		                        <label>绑定手机</label>
		                        <span>18819446135</span>
								 <a id="changePhone" href="javascript:;" data-toggle="modal" data-position="center" data-target="#open-dailog-phone">修改手机号</a>
		                    </li>
		                    <li>
		                        <label>绑定邮箱</label>
		                        <span>没有绑定 </span>
								<a id="setEmail" href="javascript:;" data-toggle="modal" data-position="center" data-target="#open-dailog-email">绑定邮箱</a>
		                    </li>
		                    <li>
		                        <label>设置密码</label>
		                        <span>******** <span class="ora">( 设置密码前，请先绑定邮箱或手机 )</span></span>
		                        <!-- 没绑定邮箱或手机不显示设定密码 -->
		                             <a id="changePw" href="javascript:;" data-toggle="modal" data-position="center" data-target="#open-dailog-phone">修改登录密码</a>
		                    </li>
		                </ul>
		            </div>
				  </div>
				  <div class="tab-pane fade main" id="tabContent3">
		            ...
		            <section class="notify">
		                <form id="notifyForm" method="post" action="">
		                    ...
		                    <img src="https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=gQHP7zoAAAAAAAAAASxodHRwOi8vd2VpeGluLnFxLmNvbS9xL2h6amhuSkxsMXZTdlBBeWIyUllKAAIE_zEjWAMEAOkHAA%3D%3D" width="150px">
		                    ...
		                    <fieldset>
		                        <div class="form-item">
		                            ...
		                            <div id="verifyOther" style="display: block;">
		                                ...
		                                <div class="item-cont no-right">
		                                    <input class="txt sm init-email" type="text">
		                                </div>
		                            </div>
		                        </div>
		                        <div class="form-item">
		                            <div class="item-cont">
		                                <input type="button" id="verifyIdBtn" class="btn green-btn lg" value="发送邮箱">
		                            </div>
		                        </div>
		                    </fieldset>
		                </form>
		...
		<script type='text/javascript' src='/term/newSpaperSystem/Application/Home/View/public/js/jquery.1.7.2.min.js' charset='utf-8'></script>
		<script type='text/javascript' src='/term/newSpaperSystem/Application/Home/View/public/js/zui.min.js' charset='utf-8'></script>
		<script type='text/javascript' src='/term/newSpaperSystem/Application/Home/View/public/js/datetimepicker.js' charset='utf-8'></script>
