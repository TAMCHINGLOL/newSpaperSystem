			...
			<div class="common-head">
				<div class="common-portrait">
					<?php if($info["head_img"] != ''): ?><img src="<?php echo ($info["head_img"]); ?>" width="80px" alt="头像">
						<?php else: ?><img src="/term/newSpaperSystem/Application/Home/View/public/img/default.gif" width="80px" alt="头像"><?php endif; ?>
					...
					<h3>
						<span>
							<?php if($info["alias"] != ''): echo ($info["alias"]); ?>
								<?php else: echo ($info["username"]); endif; ?>
						</span>
					</h3>
					<p class="common-data-info"><span>性别：<?php echo ($info["sex"]); ?></span>
						<span class="local">现居住地： <?php echo ($info["address"]); ?></span>
					</p>
					<!--<p class="common-data-detail">个人签名：<?php echo ($info["backup"]); ?></p>-->
					<p class="common-data-detail">个人邮箱：<?php echo ($info["email"]); ?></p>
				</div>
				<!--<a href="../personal/personalset.html" class="edit-data">编辑个人资料</a>-->
			</div>
			<div class="user-course">
				<div class="course-nav" id="courseNav">
					<a id="navHome" class="active" data-toggle="tab" href="#tabContent1">未读信箱</a>
					<a id="navStudy" class="" data-toggle="tab" href="#tabContent2">已读信箱</a>
				</div>
				<div class="user-course-content tab-content">
					<div class="user-course-cont tab-pane fade active in " id="tabContent1">
					...
					<div class="user-course-cont tab-pane fade" id="tabContent2">
						<div id="learn-course-missing">
							<div class="items">
								<div class="item">
									<div class="item-heading">
