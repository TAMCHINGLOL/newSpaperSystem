				...
				<div class="icon-box">
					...
					<span class="relative loginlist login-icon" id="loginlist">
						<dl class="submenu"><i class="top-icon"></i>
							<dd><a href="http://passport.jikexueyuan.com/sso/reg_phone" class="reg-btn">注册</a>|<a href="<?php echo U('Home/Login/index');?>" class="login-btn">登录</a></dd>
							<dd><a href="http://passport.jikexueyuan.com/sso/login"><i class="xxzx-icon"></i>学习中心</a></dd>
							<dd><a href="personal/home.html"><i class="grzy-icon"></i>个人主页</a></dd>
							<dd><a href="personal/newspull.html"><i class="xxtz-icon"></i>消息通知</a></dd>
							<dd><a href="personal/personalset.html"><i class="zhsz-icon"></i>账号设置</a></dd>
						</dl>
					</span>
				</div>
		...
		<div class="centent mar-t20">	
			...
			<div class="cards">
			  <div class="col-md-4 col-sm-6 col-lg-3">
			    <a class="card" href="###">
			      <img src="http://jiuye-res.jikexueyuan.com/zhiye/showcase/attach-/20161013/2a7bf0a0-d94d-40d4-a244-20e5a5e359e6.jpg" alt="">
				...
				<div class="list list-condensed">
					  ...
					  <div class="items items-hover">
					    ...
					    <div class="item">
					      ...
					      <div class="item-content">
					        <div class="media pull-right"><img src="http://jiuye-res.jikexueyuan.com/zhiye/showcase/attach-/20161013/2a7bf0a0-d94d-40d4-a244-20e5a5e359e6.jpg" alt=""></div>
					        <div class="text">HTML 5草案的前身名为Web Applications 1.0，是在2004年由WHATWG提出。2008年1月22日，第一份正式草案发布。WHATWG表示该规范是目前仍在进行的工作，仍须多年的努力。[8]目前Mozilla Firefox、Google Chrome、Opera、Safari（版本4以上）、Internet Explorer（版本9以上）已支持HTML5技术。</div>
					      </div>
					      <div class="item-footer">
					        <a href="#" class="text-muted"><i class="icon-comments"></i> 243</a> &nbsp; <span class="text-muted">2013-11-11 16:14:37</span>
					...
					<ul class="story">
		                ...
		                <li class="col-md-4">
		                    <a href="http://blog.jikexueyuan.com/7.html" target="_blank">
		                        <div class="story-content">
		                            <p>Web大前端工程师就业班五期 03 班学员，某 985 大学信息与计算科学 2016 届毕业生，2 个月完成 16 个任务，被同班同学称为「大神」。2016 年拿到毕业证书的同时也拿到了 15K 高薪的 offer。</p>
		                        </div>
		                        <div class="story-info">
