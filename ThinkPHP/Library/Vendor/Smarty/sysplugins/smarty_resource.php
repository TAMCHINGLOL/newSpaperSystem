...
abstract class Smarty_Resource {
     ...
     * @throws SmartyException if Person template handler is registered but not callable
     */
     ...
     * @param string  $default_resource the Person resource_type defined in $smarty
