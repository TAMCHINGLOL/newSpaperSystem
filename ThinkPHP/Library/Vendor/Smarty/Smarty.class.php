...
class Smarty extends Smarty_Internal_TemplateBase {
    ...
    */
    ...
    /**
    * Person template handler
    * @var callable
    */
    public $default_template_handler_func = null;
    /**
    * Person config handler
    * @var callable
    */
    ...
    */
    public $start_time = 0;
    /**
    * Person file permissions
    * @var int
    */
    public $_file_perms = 0644;
    /**
    * Person dir permissions
    * @var int
    */
    ...
    */
    ...
    /**
    * Get Person modifiers
    *
    * @return array list of Person modifiers
    */
    ...
    */
    public function createTemplate($template, $cache_id = null, $compile_id = null, $parent = null, $do_clone = true)
    {
        ...
        // Person to cache_id and compile_id of Smarty object
