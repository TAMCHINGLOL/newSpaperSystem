 ...
 * @Company:
 * @Author: ldz
 * @Since: 2017/1/18 16:13
 * @Description: 描述存放常用Http协议请求方式
 */
...
class Http
{
     ...
     * @Author: ludezh
     */
    static public function curlPost($url, $postData = array(), $timeout = 5, $header = "", $dataType = "")
    {
     ...
     * @Author: ludezh
     */
    static public function socketPost($url, $post_data = array(), $isAsyn = true, $timeout = 5, $header = "", $data_type = "")
    {
        $header = empty($header) ? self::defaultHeader() : $header;
        //支持json数据数据提交
        if ($data_type == 'json') {
